...
const BookAppointment = ({ data }) => {
 ...
 useEffect(() => {
  const fetchProceduresData = async () => {
    try {
      const response = await fetch("http://65.0.30.13:8080/api", {
        method: "POST",
        headers: {
    ...
    const fetchPatientData = async () => {
      try {
        const response = await axios.get(
          `http://65.0.30.13:8080/api/patients/${patientId}`
        );
  ...
  useEffect(() => {
    const fetchProcedureData = async () => {
      try {
        const response = await axios.get(
          "http://65.0.30.13:8080/Procedure/procedures/patient"
        );
  ...
  const handleProcedureChange = async (procedureId) => {
    ...
    try {
      const response = await axios.get(
        `http://65.0.30.13:8080/Procedure/providers/${procedureId}`
      );
  ...
  const handleProviderChange = async (providerId) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://65.0.30.13:8080/doctors/${providerId}`
      );
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      // const response = await axios.post('http://65.0.30.13:8080/api/appointments', {
