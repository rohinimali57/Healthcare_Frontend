...
const HomeThreeHeroSection = () => {
  ...
  useEffect(() => {
    const getspeciality = async () => {
      await fetch("http://65.0.30.13:8080/Procedure/speciality", {
        method: "GET",
        headers: {
  ...
  useEffect(() => {
    if (selectedSpeciality) {
      const getprocedure = async () => {
        await fetch(
          `http://65.0.30.13:8080/Procedure/procedure/${selectedSpeciality}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  useEffect(() => {
    if (selectedProcedure) {
      const getlocation = async () => {
        await fetch(
          `http://65.0.30.13:8080/Procedure/city/${selectedProcedure}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  const onBookProcedure = async (e) => {
    ...
    await fetch(
      "http://65.0.30.13:8080/Procedure/speciality/searchProcedurehome",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const onSearch = async (e) => {
    ...
    await fetch("http://65.0.30.13:8080/Procedure/freeSearchProcedurehome", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
