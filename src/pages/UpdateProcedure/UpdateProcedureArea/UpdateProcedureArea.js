...
const UpdateProcedureArea = ({ procedure }) => {
      ...
      const fetchData = async () => {
         try {
            ...
            const response = await axios.get(
               `http://65.0.30.13:8080/providerprofiles/${procedure.id}`
            );
   ...
   const fetchData1 = async () => {
      try {
         const response = await axios.get(
            `http://65.0.30.13:8080/provider/doctors/search/${storedProviderId}`
         );
         const result = response.data;
   ...
   const fetchOption = async () => {
      ...
      try {
         const response = await axios.get(
            `http://65.0.30.13:8080/procedure/option/${procedure.id}`
         );
         const result = response.data;
   ...
   const handleProcedureRegistration = async (e) => {
      ...
      try {
         const response = await axios.put(
            `http://65.0.30.13:8080/Procedure/update/${id}`,
            formData,
            {
               headers: {
