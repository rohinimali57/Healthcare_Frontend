...
function AddAccomodationDetailsArea() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://65.0.30.13:8080/accommodation/${storedPId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post('http://65.0.30.13:8080/accommodation', {
            rates: rates,
            providerId: pId,
    ...
    const handleDelete = async (index) => {
        ...
        try {
            const response = await axios.delete(`http://65.0.30.13:8080/accommodation/${accommodation_id}`);
